...
pub fn run() {
    // let a1: [u8; 900_0000] = [1; 900_0000];
    // "fatel runtime error: stack overflow"が出力されない問題
    // "zsh: segmentation fault  cargo run" のみが出力される
    ...
    println!("Heap address of data is: {:p}", b1);
